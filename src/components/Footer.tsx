        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-6">
              Your one-stop solution for blue-collar services across India, connecting verified professionals with customers.
            </p>
            
            <div className="flex space-x-4">
              <a href="#" className="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center hover:bg-brand-blue transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">View All 69+ Services</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Bangalore</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Chennai</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Hyderabad</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">View All 50+ Cities</a></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between gap-6">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Task Express. All rights reserved.
            </p>
          ...
          <p className="mt-4 text-xs text-gray-500">
            Task Express is a platform that connects users with blue-collar service professionals across India. The platform acts as a marketplace and is not responsible for the services provided by the professionals.
          </p>
        </div>
      </div>
    </footer>
